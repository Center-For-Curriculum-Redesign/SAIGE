...
import { AnalysisNode, PromptNode, PromptCoordinator, MatchFilter } from "../reasoning_prompts.js";
...
export function ponderPromptInst(newAsst, endpoints_available) {
    ...
    let metatags = new MatchFilter(['<meta-decision>', '<meta>', '<meta-answer>'], ['</meta-decision>', '</meta>', '</meta-answer>']);
    let searchOrConverse = new MatchFilter(['##SEA','##CONV'] , ['ARCH##', 'ERSE##']);
    ...
    basic.setTaskHintMatchFilter('meta', metatags);
